...
typedef uint8_t gpio_pull_mode_t;
typedef uint8_t gpio_int_type_t;
typedef uint8_t gpio_drive_cap_t;
...
typedef struct {
    ...
    uint8_t mode;               /*!< GPIO mode: set input/output mode                     */
    uint8_t pull_up_en;       /*!< GPIO pull-up                                         */
    uint8_t pull_down_en;   /*!< GPIO pull-down                                       */
